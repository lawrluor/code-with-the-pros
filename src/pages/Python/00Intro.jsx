...
const Intro = () => {
  ...
  return (
    <div className="lesson-container">
      ...
      <section>
        <h2 id="what-is-programming"><a href="#what-is-programming" className="section-link">What is Programming?</a></h2>
      ...
      <section>
        <h2 id="comments"><a href="#comments" className="section-link">Comments</a></h2>
...
print(10 * 5 / 2)     # Results in 25.0`} />
      ...
      <section>
        <h2 id="data-types"><a href="#data-types" className="section-link">Data Types</a></h2>
...
print(-11 // 3)  # Outputs: -4 (integer division)`} />
        ...
        <Collapsible title={`Challenge ${getCurrentNumberAndIncrement()}`}>
          ...
          <p>There are 17 apples, and there are 4 people in total. How many whole apples does each person get?</p>
        </Collapsible>
