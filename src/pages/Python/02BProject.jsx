...
const Project02B = () => {
	return (
		<div className="lesson-container">
			...
			<section>
				<h2>Step 1: Collecting Customer Details</h2>
			...
			<section>
				<h2>Step 2: Storing Purchase Details</h2>
			...
			<section>
				<h2>Step 3: Calculating Total Cost</h2>
			...
			<section>
				<h2>Step 4: Formatting the Invoice</h2>
