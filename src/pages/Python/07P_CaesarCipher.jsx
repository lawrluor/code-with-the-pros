  ...
  return (
    <div className="lesson-container">
      ...
      <section>
        ...
        <p>In this project, we'll build a Caesar cipher, a simple encryption technique used since ancient times. Imagine you want to send a secret message to your friend, but you don't want anyone else to be able to read it. A Caesar cipher allows you to shift the letters in your message by a certain number of positions, making it appear scrambled to anyone who doesn't know the secret shift value.</p>

        <p>Topics covered: conditionals, loops, strings, and user input, with the option for functions.</p>
      </section>
...
# 90: Z`}
        />
        <a href="asciitable.com" target="_blank" rel="noopener noreferrer">View the full table here.</a>
...
`} />
      ...
      <section>
        ...
        <p>We'll write code that allows us to take a message, then a shift value, as input. The function will iterate through each character in the message and shift it according to the provided value. It will then return the encrypted message.</p>
      </section>

      <section>
        <h2>3. Building the Decryption Function</h2>
        <p>Similar to encryption, we'll write code that takes an encrypted message and the shift value. This function will shift the characters back by the same amount, revealing the original message.</p>
      </section>
