...
return (
	<div className="lesson-container">
		...
		<section>
			<h3>Step 0: Define Your Inputs</h3>
		...
		<section>
			<h3>Step 1: Check Username Length</h3>
		...
		<section>
			<h3>Step 2: Ensure the End of the Username Contains a Number</h3>
		...
		<section>
			<h3>Step 3: Ensure the Password is Not the Same as Username</h3>
		...
		<section>
			<h3>Step 4: Check Password for Common Passwords</h3>
		...
		<section>
			<h3>Step 5: Check Password Length</h3>
		...
		<section>
			<h3>Step 6: Check Password for Only Numbers</h3>
...
"ab1".isnumeric()  # Outputs: False`} />
		...
		<section>
			<h3>Step 7: A Mix of Uppercase and Lowercase Letters</h3>
		...
		<section>
			<h3>Step 9: An Unwelcome Surprise</h3>
