...
const Project04B = () => {
  ...
  return (
    <div className="lesson-container">
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-define-your-inputs`}><a href={`#step-${getCurrentNumber()}-define-your-inputs`} className="section-link">Step {getCurrentNumberAndIncrement()}: Define Your Inputs</a></h2>
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-check-username-length`}><a href={`#step-${getCurrentNumber()}-check-username-length`} className="section-link">Step {getCurrentNumberAndIncrement()}: Check Username Length</a></h2>
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-ensure-username-contains-number`}><a href={`#step-${getCurrentNumber()}-ensure-username-contains-number`} className="section-link">Step {getCurrentNumberAndIncrement()}: Ensure the End of the Username Contains a Number</a></h2>
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-check-password-not-username`}><a href={`#step-${getCurrentNumber()}-check-password-not-username`} className="section-link">Step {getCurrentNumberAndIncrement()}: Ensure the Password is Not the Same as Username</a></h2>
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-check-password-common`}><a href={`#step-${getCurrentNumber()}-check-password-common`} className="section-link">Step {getCurrentNumberAndIncrement()}: Check Password for Common Passwords</a></h2>
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-check-password-length`}><a href={`#step-${getCurrentNumber()}-check-password-length`} className="section-link">Step {getCurrentNumberAndIncrement()}: Check Password Length</a></h2>
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-check-password-not-all-numbers`}><a href={`#step-${getCurrentNumber()}-check-password-not-all-numbers`} className="section-link">Step {getCurrentNumberAndIncrement()}: Check Password for Only Numbers</a></h2>
...
"ab1".isnumeric()  # Outputs: False`} />
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-check-mixed-case`}><a href={`#step-${getCurrentNumber()}-check-mixed-case`} className="section-link">Step {getCurrentNumberAndIncrement()}: A Mix of Uppercase and Lowercase Letters</a></h2>
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-final-validation`}><a href={`#step-${getCurrentNumber()}-final-validation`} className="section-link">Step {getCurrentNumberAndIncrement()}: Final Validation</a></h2>
      ...
      <section>
        <h2 id={`step-${getCurrentNumber()}-admin-exception`}><a href={`#step-${getCurrentNumber()}-admin-exception`} className="section-link">Step {getCurrentNumberAndIncrement()}: An Unwelcome Surprise</a></h2>
