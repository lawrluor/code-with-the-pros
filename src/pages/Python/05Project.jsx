...
export default function Project05() {
	...
	return <div className="lesson-container">
		...
		<section>
			<h2 id={`step-${getCurrentNumber()}-create-the-function-header`}><a href={`#step-${getCurrentNumber()}-create-the-function-header`} className="section-link">Step {getCurrentNumberAndIncrement()}: Create the Function Header</a></h2>
		...
		<section>
			<h2 id={`step-${getCurrentNumber()}-calculating-the-base-cost`}><a href={`#step-${getCurrentNumber()}-calculating-the-base-cost`} className="section-link">Step {getCurrentNumberAndIncrement()}: Calculating the Base Cost</a></h2>
		...
		<section>
			<h2 id={`step-${getCurrentNumber()}-add-a-handling-fee`}><a href={`#step-${getCurrentNumber()}-add-a-handling-fee`} className="section-link">Step {getCurrentNumberAndIncrement()}: Add a Handling Fee</a></h2>
		...
		<section>
			<h2 id={`step-${getCurrentNumber()}-apply-a-bulk-discount`}><a href={`#step-${getCurrentNumber()}-apply-a-bulk-discount`} className="section-link">Step {getCurrentNumberAndIncrement()}: Apply a Bulk Discount</a></h2>
		...
		<section>
			<h2 id={`step-${getCurrentNumber()}-return-the-calculated-cost`}><a href={`#step-${getCurrentNumber()}-return-the-calculated-cost`} className="section-link">Step {getCurrentNumberAndIncrement()}: Return the Calculated Cost</a></h2>
		...
		<section>
			<h2 id={`step-${getCurrentNumber()}-handling-orders`}><a href={`#step-${getCurrentNumber()}-handling-orders`} className="section-link">Step {getCurrentNumberAndIncrement()}: Handling Orders</a></h2>
		...
		<section>
			<h2 id={`challenges`}><a href={`#challenges`} className="section-link">Challenges</a></h2>
			<p>
		...
		<section>
			<h2 id={`bonus-challenges`}><a href={`#bonus-challenges`} className="section-link">Bonus Challenges</a></h2>
