...
const ForLoops = () => {
  return (
    <div className="lesson-container">
      ...
      <section>
        <h2 id="why-use-for-loops"><a href="#why-use-for-loops" className="section-link">Why Use For Loops?</a></h2>
...
print("Hello"[4])  # Prints 'o'`} />
        ...
        <p>As we have learned previously, we could use a while loop to print each character of a string:</p>
...
while i < len(message):
    ...
    i += 1`} />
        ...
        <p>However, there is an even better way to do this in Python - using a <code className="inline">for</code> loop. A <code className="inline">for</code> loop is designed to complete this task and is the simplest way to do so.</p>
